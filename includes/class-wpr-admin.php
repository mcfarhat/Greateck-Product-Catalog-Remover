...
class WPR_Admin {
	...
	public function register_menu() {
		add_menu_page(
			__( 'Greateck Product Catalog Remover for WooCommerce', 'woo-product-remover' ),
			__( 'Catalog Remover', 'woo-product-remover' ),
			self::CAPABILITY,
			self::SLUG,
	...
	public function render_page() {
		...
		<div class="wrap wpr-wrap">
			<h1><?php esc_html_e( 'Greateck Product Catalog Remover for WooCommerce', 'woo-product-remover' ); ?></h1>
			...
			<p class="wpr-credit">
				...
				printf(
					...
					esc_html__( 'Thank you for using Greateck Product Catalog Remover by %s', 'woo-product-remover' ),
